      ...
      <div className="container-custom relative z-10">
        ...
        duration: 0.6
          ...
          delay: 0.3
            ...
            <a href="mailto:hello@aftercollage.com" className="flex items-center justify-center gap-2 px-6 py-4 gradient-bg text-primary-foreground font-semibold rounded-2xl hover:opacity-90 transition-opacity">
              <Handshake className="w-5 h-5" />
              Partner With Us
            </a>
            <a href="mailto:invest@aftercollage.com" className="flex items-center justify-center gap-2 px-6 py-4 glass rounded-2xl font-semibold hover:bg-secondary/80 transition-colors">
              <Mail className="w-5 h-5" />
              Contact Us
            </a>
            <a href="#" className="flex items-center justify-center gap-2 px-6 py-4 glass rounded-2xl font-semibold hover:bg-secondary/80 transition-colors">
              <Rocket className="w-5 h-5" />
              Join Early Access
            </a>
            <a href="#" className="flex items-center justify-center gap-2 px-6 py-4 glass rounded-2xl font-semibold hover:bg-secondary/80 transition-colors group">
