...
import { Mail, Handshake, Rocket, Download } from "lucide-react";
import { PartnerForm } from "@/components/forms/PartnerForm";
import { ContactForm } from "@/components/forms/ContactForm";
import { EarlyAccessForm } from "@/components/forms/EarlyAccessForm";
import { AppComingSoonModal } from "@/components/forms/AppComingSoonModal";
...
const CTA = () => {
  ...
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      {/* Form Modals */}
      <PartnerForm open={partnerOpen} onOpenChange={setPartnerOpen} />
      <ContactForm open={contactOpen} onOpenChange={setContactOpen} />
      <EarlyAccessForm open={earlyAccessOpen} onOpenChange={setEarlyAccessOpen} />
      <AppComingSoonModal open={appComingSoonOpen} onOpenChange={setAppComingSoonOpen} />
    </section>
  );
};
