    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-custom relative z-10 text-center px-4">
        ...
        >
          <a 
            href="#demo" 
            className="inline-flex items-center justify-center gap-2 px-8 py-4 gradient-bg text-primary-foreground font-bold rounded-2xl hover:opacity-90 transition-all glow-primary btn-bouncy text-lg"
          >
            Explore the Product
          ...
          <a 
            href="#features" 
            className="inline-flex items-center justify-center gap-2 px-8 py-4 glass rounded-2xl font-bold hover:border-primary/50 transition-all btn-bouncy text-lg"
          >
            View Features
